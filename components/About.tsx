  ...
  return (
    <section id="sobre" className="py-24 bg-white overflow-hidden relative">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none">
        <div className="absolute left-0 top-0 w-96 h-96 bg-emerald-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-emerald-500 font-bold tracking-widest uppercase text-sm mb-4 block">Quem Somos</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#001B3D] mb-8 leading-tight">
            Somos novos no mercado, mas experientes no <span className="text-emerald-500 underline decoration-emerald-500/30 underline-offset-8">sucesso do cliente.</span>
          </h2>
          ...
          <div className="mt-12 space-x-6">
             <button onClick={() => setView('sobre')} className="bg-[#001B3D] text-white font-bold px-8 py-4 rounded-xl hover:bg-emerald-600 transition-all">
               Saiba mais sobre nós
             </button>
             <a href="https://fishweb.my.canva.site/peixeweb" target="_blank" className="inline-flex items-center gap-2 font-bold text-blue-600 hover:text-blue-700 transition-colors group text-lg">
