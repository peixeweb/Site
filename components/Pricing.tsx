  ...
  return (
    <section id="pricing" className="py-24 bg-white text-black">
      <div className="container mx-auto px-6 max-w-5xl text-center">
        <h2 className="text-3xl md:text-5xl font-black mb-6">PRONTO PARA ESCALAR?</h2>
        <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto">
          Não acreditamos em pacotes genéricos. Cada negócio tem um desafio único e merece uma estratégia personalizada.
        </p>
        
        <div className="bg-[#111] text-white rounded-[40px] p-8 md:p-12 border-4 border-yellow-500 shadow-2xl relative overflow-hidden">
